...
--
-- ⚠ สิ่งที่ตั้งใจ "ไม่" เพิ่มในไฟล์นี้
--   ตาราง PERSONNEL (ยศ-ชื่อ-สกุล · หมู่เลือด · แพ้ยา · โรคประจำตัว) ของผู้ป่วย
--
--   ⚠⚠ ข้อนี้ถูกกลับด้านแล้วใน 0019_casualty.sql (8 ก.ย. 2569) ⚠⚠
--   เจ้าของโครงการตัดสินใจให้เก็บ เพราะแบบฟอร์มที่หน่วยใช้จริงมีช่องเหล่านี้
--   ถ้าระบบไม่มี ผู้ใช้จะกลับไปจดกระดาษคู่กันซึ่งไม่มี RLS และลบตามคำขอไม่ได้
--   AI_RULES.md §3.1 ถูกแก้ให้ตรงกับความจริงข้อนี้แล้ว
--   เหตุผลที่แยกเป็นตาราง casualty แทนที่จะเพิ่มคอลัมน์ที่นี่ อยู่ในหัวไฟล์ 0019
--
--   ตาราง DEATH_RECORD (ทบ.466-904 ใบชันสูตรพลิกศพ) เป็นเอกสารที่มีผลทางกฎหมาย
--   ต้องผ่านนายทหารพระธรรมนูญก่อน — ข้อนี้ยังไม่เปลี่ยน เฟสนี้บันทึกแค่ outcome = 'died'
-- =============================================================
