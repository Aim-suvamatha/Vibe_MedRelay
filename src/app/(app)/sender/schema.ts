...
/**
 * ★ ป้ายบนจอต่างจากศัพท์ของแบบฟอร์มโดยเจตนา (คำสั่งเจ้าของโครงการ 9 ก.ย. 2569)
 *   ค่าในฐานข้อมูลยังเป็น 'hospitalized' ตาม ทบ.466-900 เพราะรายงานที่ส่ง
 *   หน่วยเหนือต้องใช้คำของแบบฟอร์ม แต่คำว่า "คงพยาบาล" ไม่ใช่คำที่คนหน้างานใช้
 *   และอ่านแล้วไม่รู้ว่าต้องทำอะไรต่อ — "รับป่วย ดูอาการที่จุดนี้" บอกการกระทำจริง
 */
export const OUTCOME_LABEL: Record<CaseOutcome, string> = {
  recovered: "หาย · กลับปฏิบัติหน้าที่ได้",
  hospitalized: "รับป่วย ดูอาการที่จุดนี้",
  died: "ตาย",
};
