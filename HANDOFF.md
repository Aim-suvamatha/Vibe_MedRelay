# 🚩 สถานะล่าสุด · 8 ก.ย. 2569 — ค้างอยู่ที่ "ทดสอบด้วยตาในเบราว์เซอร์"

> **session ใหม่อ่านหัวข้อนี้ก่อนหัวข้ออื่นทั้งหมด** แล้วค่อยลงไปอ่าน §1 ตามปกติ
> งานรอบล่าสุดคือทำฝั่งผู้ส่งให้ตรงแบบฟอร์ม ทบ.466-900/901/902/903
> **โค้ดเขียนเสร็จแล้วและ migration ลงฐานข้อมูลจริงแล้ว เหลือแค่เดินทดสอบด้วยมือ**
...
| `form_test.sql` บนของจริง | ✅ **50/50 PASS** (เพิ่มหมวด M 11 ข้อ · N 3 ข้อ) |
| `npm run db:test` (PGlite) | ✅ **91/91 PASS** |
| `npm run test:unit` | ✅ **14/14 PASS** |
| typecheck · lint · build | ✅ ผ่านหมด |
| PostgREST | ✅ embed `case → casualty` ผูกได้ · RPC ใหม่ 43 พารามิเตอร์เห็นแล้ว |
