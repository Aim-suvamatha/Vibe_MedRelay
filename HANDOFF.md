...
⚠️ **โค้ด `/track` ตัวเต็มยังไม่ได้ deploy** — ที่ออนไลน์อยู่คือฉบับก่อนหน้า
ต้องรัน `vercel --prod --yes` ใหม่ก่อนสาธิต
...
| 2 | เติม `/track` ให้ครบวงจร + ปุ่มจัดรถในหน้าเดียวกัน | ~2 ชม. | ✅ เสร็จ |
| 3 | `vercel --prod --yes` เอาโค้ด `/track` ขึ้นออนไลน์ | ~10 นาที | ⬜ **ทำก่อน** |
| 4 | `/dashboard` การ์ดตัวเลข 4 ใบ | ~1.5 ชม. | ⬜ |
| 5 | README "รันระบบใน 5 นาที" + ซ้อม demo | ~1 ชม. | ⬜ |
| 6 | `/dispatch` คิวคำขอ + กระดานรถ | ~1 ชม. | ⬜ ตัดได้ถ้าเวลาหมด |
...
|---|---|---|---|
| 1 | **`vercel --prod --yes`** | ~10 นาที | ที่ออนไลน์ยังเป็นโค้ดเก่า สาธิตไม่ได้จนกว่าจะ deploy |
| 2 | `/dashboard` การ์ดตัวเลข 4 ใบ | ~1.5 ชม. | view พร้อมแล้ว เหลือแต่ UI · เป็นข้อพิสูจน์หลักของโครงการ |
| 3 | README "รันระบบใน 5 นาที" | ~1 ชม. | **ห้ามตัด** กรรมการใช้ตรงนี้ตัดสิน |
| 4 | `/dispatch` คิวคำขอ + กระดานรถ | ~1 ชม. | ทำได้จาก `/track` แล้ว หน้านี้แค่ทำให้เห็นภาพรวมหลายเคสพร้อมกัน |
