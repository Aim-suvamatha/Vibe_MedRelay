...
3. **Prompt 01–09 เสร็จครบ** ยกเว้น CSV export (F7) ที่ตัดไว้ท้ายสุด
   ทุกหน้าที่ปุ่มล่างพาไปมีเนื้อหาจริงหมดแล้ว **เหลืองานเดียวคือ README "รันระบบใน 5 นาที"**
...
| 5 | README "รันระบบใน 5 นาที" + ซ้อม demo | ~1 ชม. | ⬜ **เหลืองานเดียว** |
...
| ลำดับ | งาน | เวลา | ทำไมลำดับนี้ |
|---|---|---|---|
| 1 | README "รันระบบใน 5 นาที" + ซ้อม demo | ~1 ชม. | **ห้ามตัด** กรรมการใช้ตรงนี้ตัดสิน · เหลืองานเดียวแล้ว |
| 2 | CSV export (F7) | ~1 ชม. | หยิบมาทำเฉพาะถ้าเหลือเวลา · `v_casualty_report` พร้อมแล้ว |
