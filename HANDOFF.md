...
3. **Prompt 01–07 เสร็จครบ และ F3 ของ 08 เสร็จแล้ว** (`/track` เดินครบวงจร)
   เหลือ F2 คิวศูนย์สั่งการ · 09 (แดชบอร์ด) · 10 (README + ซ้อม demo)
...
|---|---|---|---|
| **08** | F2 ศูนย์สั่งการ + F3 ติดตามสถานะ | 6 ชม. | ✅ **F3 เสร็จแล้ว** (6 ก.ย.) · เหลือ F2 คิวคำขอ (~1 ชม.) |
...
| 3 | `/dashboard` การ์ดตัวเลข 4 ใบ | ~1.5 ชม. | ⬜ **ทำต่อ** |
| 4 | README "รันระบบใน 5 นาที" + ซ้อม demo | ~1 ชม. | ⬜ |
| 5 | `/dispatch` คิวคำขอ + กระดานรถ | ~1 ชม. | ⬜ ตัดได้ถ้าเวลาหมด |
...
| 3 | `/dispatch` คิวคำขอ + กระดานรถ | ~1 ชม. | ทำได้จาก `/track` แล้ว หน้านี้แค่ทำให้เห็นภาพรวมหลายเคสพร้อมกัน |

**สาธิตได้แล้วตั้งแต่ตอนนี้** ถ้าเวลาหมดกลางทาง ระบบที่ออนไลน์อยู่ก็เล่าเรื่องได้ครบแล้ว
เข้า `/sender` เปิดคำขอ → ระบบพาไป `/track` → สลับบัญชีเดินสถานะจนส่งมอบ
