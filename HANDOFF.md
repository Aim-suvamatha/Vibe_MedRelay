...
3. **Prompt 01–08 เสร็จครบ** ทั้ง F2 (คิวศูนย์สั่งการ) และ F3 (ติดตามสถานะ)
   ทุกหน้าที่ปุ่มล่างพาไปมีเนื้อหาจริงหมดแล้ว เหลือ 09 (แดชบอร์ด) · 10 (README + ซ้อม demo)
...
| 4 | `/dashboard` การ์ดตัวเลข 4 ใบ | ~1.5 ชม. | ⬜ **ทำต่อ** |
...
|---|---|---|---|
| 1 | `/dashboard` การ์ดตัวเลข 4 ใบ | ~1.5 ชม. | view พร้อมแล้ว เหลือแต่ UI · เป็นข้อพิสูจน์หลักของโครงการ |
| 2 | README "รันระบบใน 5 นาที" | ~1 ชม. | **ห้ามตัด** กรรมการใช้ตรงนี้ตัดสิน |
